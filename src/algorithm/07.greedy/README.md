...
**[Code](./134.gas-station.py)**

**Notes:**
Key Point:
`i` i accumulates from 0, and denoted as tank. When tank < 0, it means that the interval [0, i] cannot be used as the starting position. So we chose i+ 1 as start index, and reset tank = 0.